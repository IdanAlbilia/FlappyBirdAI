...
def draw_window(win, birds, pipes, base, score, gen, pipe_ind):
    ...
    text_gen = STAT_FONT.render("Gens: " + str(gen-1), 1, (255, 255, 255))
    win.blit(text_gen, (10, 10))

    text_alive = STAT_FONT.render("Alive: " + str(len(birds)), 1, (255, 255, 255))
...
def main(genomes, config):  # fitness function
    ...
    # base = Base(560)
    # pipes = [Pipe(600)]
    # win = pygame.display.set_mode((WIN_WIDTH, WIN_HEIGHT - 200))
